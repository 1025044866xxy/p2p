...
public class ExecteSqlLogInterceptor implements Interceptor {
    ...
    private static Logger daoLogger = LoggerFactory.getLogger("com.xxy.p2p.daodao");
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        String exexcSql = getSql(configuration, sqlId ,boundSql);
        Long startTime = System.currentTimeMillis();
        daoLogger.debug(exexcSql);
        Object result = null;
        try{
            result = invocation.proceed();
        }finally {
            Long speedTime = System.currentTimeMillis()-startTime;
            daoLogger.debug(speedTime.toString()+"MS");
        }
        return result;
    }
    ...
    private String getSql(Configuration configuration, String sqlId, BoundSql boundSql){
